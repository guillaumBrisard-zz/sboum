package com.gb.sboum.utils.log;
...
public class LoggableAspect {
	 ...
	 */
	@Around("execution(public * (@com.gb.sboum.utils.log.Loggable *).*(..))" //
			+ " && !execution(String *.toString())" //
			+ " && !execution(int *.hashCode())" //
			+ " && !execution(boolean *.canEqual(Object))" //
			+ " && !execution(boolean *.equals(Object))" //
			+ " && !cflow(call(com.gb.sboum.utils.log.LoggableAspect.new()))")
	 ...
	 *             If something goes wrong inside
	 */
	@Around("(execution(* *(..)) || initialization(*.new(..)))" + " && @annotation(com.gb.sboum.utils.log.Loggable)")
